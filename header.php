			...
			<div class="flexrow clear">
		        ...
		        <div class="rightcol">
		        	<div class="social-media">
		        		<?php if ($faceboook) { ?>
		        		<a class="facebook" href="<?php echo $faceboook ?>"><i aria-hidden="true" class="fab fa-facebook"></i></a>
		        		<?php } ?>
		        		<?php if ($twitter) { ?>
		        		<a class="twitter" href="<?php echo $twitter ?>"><i aria-hidden="true" class="fab fa-twitter-square"></i></a>
		        		<?php } ?>
		        		<?php if ($instagram) { ?>
		        		<a class="instagram" href="<?php echo $instagram ?>">
